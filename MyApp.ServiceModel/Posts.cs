...
public class Comment
{
    ...
    public string? AiRef { get; set; } // comment generated by AI
}
...
{
    // Whether the comment triggered an AI Comment Task
...
public class GetLastUpdated : IGet, IReturn<GetLastUpdatedResponse>
{
    public string? Id { get; set; }
    public int? PostId { get; set; }
}
...
public class WaitForUpdate : IGet, IReturn<GetLastUpdatedResponse>
{
    [ValidateNotEmpty]
    public required string Id { get; set; }
